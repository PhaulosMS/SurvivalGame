...
void ASurvivalPlayerController::ApplyRecoil(const FVector2D RecoilAmount, const float RecoilSpeed, const float RecoilResetSpeed, TSubclassOf<UCameraShakeBase> Shake)
{
