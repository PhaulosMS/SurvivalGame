...
enum class EEquippableSlot : uint8
{
	...
	EIS_PrimaryWeapon UMETA (DisplayName = "Priamry Weapon"),
...
public:
	...
	virtual void AddedToInventory(UInventoryComponent* Inventory) override;

	UFUNCTION(BlueprintPure, Category = "Equippables")
	bool IsEquipped() const { return bEquppied; }
